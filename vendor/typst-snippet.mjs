...
function __wbg_get_imports() {
  const import0 = {
    ...
    __wbg_call_86e39d65afc3d9db: function() {
    ...
    __wbg_new_typed_323f37fd55ab048d: function(arg0, arg1) {
      try {
        ...
        var cb0 = (arg02, arg12) => {
          ...
          state0.a = 0;
          try {
            return __wasm_bindgen_func_elem_39808(a, state0.b, arg02, arg12);
          } finally {
            state0.a = a;
          }
        };
    ...
    __wbindgen_cast_0000000000000001: function(arg0, arg1) {
      const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_39816);
      return addHeapObject(ret);
    },
...
function __wasm_bindgen_func_elem_39816(arg0, arg1, arg2) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.__wasm_bindgen_func_elem_39816(retptr, arg0, arg1, addHeapObject(arg2));
...
function __wasm_bindgen_func_elem_39808(arg0, arg1, arg2, arg3) {
  wasm.__wasm_bindgen_func_elem_39808(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
var IncrServer, ProxyContext, TypstCompileWorld, TypstCompiler, TypstCompilerBuilder, TypstFontResolver, TypstFontResolverBuilder, IncrServerFinalization, ProxyContextFinalization, TypstCompileWorldFinalization, TypstCompilerFinalization, TypstCompilerBuilderFinalization, TypstFontResolverFinalization, TypstFontResolverBuilderFinalization, CLOSURE_DTORS, cachedDataViewMemory0, cachedUint32ArrayMemory0, cachedUint8ArrayMemory0, heap, heap_next, cachedTextDecoder, MAX_SAFARI_DECODE_BYTES, numBytesDecoded, cachedTextEncoder, WASM_VECTOR_LEN, wasmModule, wasm, importWasmModule;
...
var init_wasm_pack_shim = __esm({
  "node_modules/@myriaddreamin/typst-ts-web-compiler/pkg/wasm-pack-shim.mjs"() {
    ...
    init_typst_ts_web_compiler();
    init_typst_ts_web_compiler();
    wasm_pack_shim_default = __wbg_init;
...
var RenderSession, ManageStatus, TypstWorker, gRendererModule, warnOnceCanvasSet, TypstRendererDriver;
var init_renderer = __esm({
  "node_modules/@myriaddreamin/typst.ts/dist/esm/renderer.mjs"() {
    ...
    TypstRendererDriver = class {
      ...
      hitCanvasPageBound(options) {
        const result = this.renderer.hit_canvas_page_bound(options.renderSession[kObject], options.pageOffset, options.x, options.y);
